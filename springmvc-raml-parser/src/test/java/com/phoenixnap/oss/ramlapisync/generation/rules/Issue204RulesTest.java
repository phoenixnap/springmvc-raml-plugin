 ...
 * @since 0.10.12
 */
public class Issue204RulesTest extends AbstractRuleTestBase {
    ...
    public static void initRaml() throws InvalidRamlResourceException {
		AbstractRuleTestBase.RAML = RamlLoader
				.loadRamlFromFile(AbstractRuleTestBase.RESOURCE_BASE + "issue-204.raml");
    }
    ...
    public void applySpring4ControllerInterfaceRule_shouldCreate_valid_class_inheritance() throws Exception {
		...
		verifyGeneratedCode("Issue204Spring4ControllerStub", removedSerialVersionUID);
    }
}
