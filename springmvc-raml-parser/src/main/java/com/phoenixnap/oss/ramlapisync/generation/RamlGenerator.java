...
public class RamlGenerator {
	 ...
	 * @return
	 */
	public String generateClassForRaml (ApiControllerMetadata controller, String basePackage, String header) {
		String gen ="";
	...
	public String generateMethodForApiCall(ApiMappingMetadata mapping) {
		...
		String gen ="";
		gen += "\t/**\n";
		gen += "\t * " + mapping.getDescription().replaceAll("\n", "\n\t *")+"\n";
		gen += "\t */\n";
		gen += "\t@RequestMapping(value=\""+mapping.getUrl() + "\")\n";
		gen += "\tpublic ResponseEntity "+ mapping.getName() + " (" + parameters + ") { \n";
		gen += "\t\n";
