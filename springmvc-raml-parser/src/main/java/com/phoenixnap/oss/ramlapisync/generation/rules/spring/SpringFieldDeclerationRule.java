 ...
 * @since 0.4.1
 */
public class SpringFieldDeclerationRule implements Rule<JDefinedClass, JFieldVar, ApiResourceMetadata> {

    private String delegateFieldName = "delegate";
    private JDefinedClass interfaceName;

    public SpringFieldDeclerationRule(String delegateFieldName, JDefinedClass interfaceName) {
...
//        JClass controllerInterface = generatableType._implements().next();
        JFieldVar field = generatableType.field(JMod.PRIVATE, interfaceName, delegateFieldName);
