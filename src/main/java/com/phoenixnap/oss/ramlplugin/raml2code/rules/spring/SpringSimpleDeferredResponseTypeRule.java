 ...
 * NamedResponseType ...
 *
 * OUTPUT: Callable{@literal <}NamedResponseType{@literal >}
 *
 * OR: Callable{@literal <}ArrayList{@literal <}NamedResponseType
 * {@literal >}{@literal >} (if the NamedResponseType is an "array")
 *
 * @author mehdi.jouan
 * @since 0.8.9
 */
public class SpringSimpleDeferredResponseTypeRule implements Rule<JDefinedClass, JType, ApiActionMetadata> {
