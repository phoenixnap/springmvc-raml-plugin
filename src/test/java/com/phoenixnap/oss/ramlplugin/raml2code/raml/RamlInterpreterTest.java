...
public class RamlInterpreterTest extends AbstractRuleTestBase {
    ...
    public void interpretPostRequestBody() {
        ...
        ApiBodyMetadata managersPostRequest = RamlTypeHelper.mapTypeToPojo(jCodeModel, AbstractRuleTestBase.RAML, managersPostType.getType());
    ...
    public void checkJSR303() {
        ...
        ApiBodyMetadata validationsGetRequest = RamlTypeHelper.mapTypeToPojo(jCodeModel, AbstractRuleTestBase.RAML, validationsGetType.getType());
    ...
    public void interpretNestedArrays() {
        ...
        ApiBodyMetadata nestedArrayPersonsGetRequest = RamlTypeHelper.mapTypeToPojo(jCodeModel, AbstractRuleTestBase.RAML, nestedArrayPersonsGetType.getType());
    ...
    public void interpretGetResponseBodyAsArray() {
		...
		setupModel();
        ApiBodyMetadata personListsGetRequest = RamlTypeHelper.mapTypeToPojo(jCodeModel, AbstractRuleTestBase.RAML, personListsGetType.getType());
    ...
    public void interpretDeleteResponseBody() {
        ...
        ApiBodyMetadata managersDeleteRequest = RamlTypeHelper.mapTypeToPojo(jCodeModel, AbstractRuleTestBase.RAML, managersDeleteType.getType());
