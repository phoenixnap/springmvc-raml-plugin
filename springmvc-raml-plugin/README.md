...
Configuration:
	...
	objectForUnspecifiedReturnType: [OPTIONAL] set to 'true' to generate Object instead of ResponseEntity<?> return type for controllers method's when return type is not specified for the endpoint. Default: 'false'
```
